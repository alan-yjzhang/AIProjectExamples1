...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.hidden_output = nn.Linear(concat_size, hidden_size)
        self.tanh = nn.Tanh()
        self.out_output = nn.Linear(concat_size, output_size)
    ...
    def forward(self, input, hidden):
        ...
        hidden_intermediate = self.hidden_output(concat)
        hidden = self.tanh(hidden_intermediate)

        output_intermediate = self.out_output(concat)
        output = self.softmax(output_intermediate)
